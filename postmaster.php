<?php
$EMAIL = 'info@stroyglobal.com'; //  Ваш e-mail на который будут приходить заявки
$FROM = 'client-from-stroyglobal@mail.ru';  //  e-mail отправителя (иногда требуется указать разрешенный настройками e-mail)
$REPLY = 'info@stroyglobal.com';   //  e-mail для ответа 
